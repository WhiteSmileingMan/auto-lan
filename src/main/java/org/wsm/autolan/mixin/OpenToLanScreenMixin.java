    ...
    private void preInit(CallbackInfo ci) {
        ...
        if (!this.initialized) {
            ...
            if (server.isRemote()) {
                ...
                this.loadLanSettingsValues(this.autoLanState.getLanSettings());
            } else if (AutoLan.CONFIG.getConfig().lanSettings != null) {
                this.loadLanSettingsValues(AutoLan.CONFIG.getConfig().lanSettings);
            } else {
        ...
        this.addDrawableChild(ButtonWidget.builder(SAVE_TEXT,
                button -> {
                    this.autoLanState.setLanSettings(this.saveLanSettings());
        ...
        this.perWorldLoadButton = this.addDrawableChild(ButtonWidget.builder(LOAD_TEXT,
                button -> this.loadLanSettings(this.autoLanState.getLanSettings()))
